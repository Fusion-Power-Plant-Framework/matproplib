...
`matproplib` defines some standard material property names. These are:

| Property Name                      | Units         | Definition                                                        |
|-------------------------------------|--------------|-------------------------------------------------------------------|
| density                            | kg/m³         | Density of a material.                                            |
| poissons_ratio                     | —             | Poisson's ratio.                                                  |
| residual_resistance_ratio          | —             | Residual resistance ratio.                                        |                                           |
...
| magnetic_saturation                | A·m²/kg       | Magnetic saturation.                                              |
| magnetic_susceptibility            | —             | Magnetic susceptibility.                                          |
| viscous_remanent_magnetisation     | A·m²/kg       | Viscous remanent magnetisation.                                   |
| coercive_field                     | A/m           | Coercive field.                                                   |
